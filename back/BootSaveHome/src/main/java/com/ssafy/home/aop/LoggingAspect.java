...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.ssafy.home..model..*(..))")
	...
	@Around(value = "execution(* com.ssafy.home..model..*(..))")
//	@Around("onRequest()")
	...
	@AfterReturning(value = "execution(* com.ssafy.home..model..*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.home..model..*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.home..model..*(..))")
