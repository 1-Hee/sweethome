    ...
    geocoder.addressSearch(dongName, function(result, status) {
        ...
        if (status === kakao.maps.services.Status.OK) {
            ...
            let tempInfoUl = document.createElement("ul");
         	tempInfoUl.setAttribute("class", "apt-info");
         	let tempLi = document.createElement("li");
        	let tempTextNode = document.createTextNode("페이지 로딩중입니다 잠시만 기다려주세요...");
        	tempLi.appendChild(tempTextNode);
        	tempInfoUl.appendChild(tempLi);              	
